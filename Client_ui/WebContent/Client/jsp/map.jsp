...
<script type="text/javascript" src="Client/js/jquery-1.11.3.js"></script>
    ...
    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <p>
                ...
                <input type="button" value="검색하기" onclick="searchPlaces()" size="8" />
            </p>
        </div>
        <hr>
        <ul id="placesList"></ul>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new daum.maps.LatLng(37.51268610823626, 127.0589282473199), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };  
...
var lat = document.getElementById('tempY');
var lng = document.getElementById('tempX');
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        (function(marker, title) {
            ...
            daum.maps.event.addListener(marker, 'click', function() {
            	...
            	mapOption = {
            			 	center: new daum.maps.LatLng(places[i].latitude, places[i].longitude), // 지도의 중심좌표
            		        level: 3 // 지도의 확대 레벨
            		    };  
