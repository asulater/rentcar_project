...
<title>My Page | SmartChoice Rent</title>
</head>
<body>
	<header id="header">
		<div class="top-bar">
		    <div class="container">
		        <div class="row" align="right">
		        	<ul class="social-share" >
						...
						<li class="active"><a id="top" href="<s:url value="/myPage.action" />">MyPage</a></li>
...
<ul>
	<li><a href = "<s:url value = "/modifyForm.action" />">회원 정보 수정</a></li>
	<li><a href = "<s:url value = "/signOutForm.action" />">회원 탈퇴</a></li>
	<li><a href = "<s:url value = "/bookingList.action" />">예약 이력</a></li>
</ul>
</div>
</body>
